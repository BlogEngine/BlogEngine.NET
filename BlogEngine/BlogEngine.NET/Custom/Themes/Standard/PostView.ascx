...
<%} %>
    <header class="post-header">
        ...
        <div class="post-info clearfix">
            <span class="post-date"><i class="icon-calendar"></i><%=BlogSettings.Instance.Culture!="fa"? Post.DateCreated.ToString("dd MMMM yyyy") : Post.DateCreated.ToPersianFullName() %></span>
