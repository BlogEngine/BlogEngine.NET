angular.module('blogAdmin').controller('ContactsController', ["$rootScope", "$scope", "$filter", "dataService", function ($rootScope, $scope, $filter, dataService) {
    $scope.items = [];
    $scope.roles = []; 
    $scope.editItem = {};
    ...
    $scope.load = function () {
        ...
        dataService.getItems('/api/users', { take: 0, skip: 0, filter: "1 == 1", order: "UserName", process: "contacts" })
